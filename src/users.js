...
export async function verifySecuritySettings() {
    ...
    if (!ENABLE_ACCOUNTS) {
        logSecurityAlert('Your current RoutTavern configuration is insecure (listening to non-localhost). Enable whitelisting, basic authentication or user accounts.');
    }
